  ...
  return (
    <div className={styles.page}>
      ...
      <SideBySideSection
        ...
        content="
         At Yash Denti Care, we take pride in offering world-class dental treatments backed by cutting-edge technology and a patient-first approach. Recognized as the Best Dental Clinic in Hyderabad, we are dedicated to ensuring every patient receives personalized, comfortable, and results-driven dental care. Whether you're searching for a Dental Hospital Near You or a trusted team for long-term oral health, Yash Denti Care remains the preferred choice.

 Every aspect of your visit is designed to provide safety, convenience, and exceptional care. No matter the procedure—routine checkups, cosmetic enhancements, orthodontic treatments, implants, or full-mouth rehabilitation—you can rely on us for precision, safety, and excellence.

 That’s why Yash Denti Care offers transparent consultation, ethical treatment planning, and long-lasting solutions tailored to your needs. When you require the expertise of a Dental Specialist in Hyderabad, our highly skilled team ensures you are in the best hands.

        "
        imageSrc="/images/Yashcare.webp"
      />
